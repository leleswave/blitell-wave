        ...
        <div class="flex flex-col justify-between w-full overflow-auto md:h-full h-svh pt-4 pb-2.5">
            <div class="relative flex flex-col">
                ...
                <div class="flex flex-col justify-start items-center px-4 space-y-1.5 w-full h-full text-slate-600 dark:text-zinc-400">
                    ...
                    <x-app.sidebar-link text="Voicemail" icon="phosphor-voicemail" onclick="event.preventDefault(); new FilamentNotification().title('Modify this button inside of sidebar.blade.php').send()" :active="Request::is('voicemail')">Voice Mail</x-app.sidebar-link>
                    <x-app.sidebar-link text="Extensions" icon="phosphor-puzzle-piece" onclick="event.preventDefault(); new FilamentNotification().title('Modify this button inside of sidebar.blade.php').send()" :active="Request::is('extensions')">Extensions</x-app.sidebar-link>
                </div>
